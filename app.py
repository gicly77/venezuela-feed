...
.title { font-size: 1rem; color: #f0f6fc; text-decoration: none; font-weight: 600; line-height: 1.3; }
.time-badge { font-size: 0.6rem; color: #fff; background: #238636; padding: 1px 6px; border-radius: 4px; font-weight: 600; }

.header-col { font-size: 0.85rem; color: #8b949e; text-transform: uppercase; letter-spacing: 2px;
